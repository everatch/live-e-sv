...
<html><head>
	...
	<meta property="og:site_name" content="LiveE! Sensor Viewer"/>
		...
		if (navigator.userAgent.indexOf('iPhone') != -1 || navigator.userAgent.indexOf('Android') > 0) {  
			<?php
				...
				if (isset($_GET['pc']) || isset($_COOKIE['pc'])){
					if(@$_GET['pc'] == 'true' || @$_COOKIE['pc'] == 'true'){
						$pc_timeout = time() + 3650 * 86400;
						setcookie('pc','true',$pc_timeout);
					}else if(@$_COOKIE['pc'] == 'false'){
