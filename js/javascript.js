...
function content_show(input) {
	if(document.getElementById("content_top").className=='appear'){
		document.getElementById("content_top").className='disappear';
	}else if(document.getElementById("content_gomap").className=='appear'){
		document.getElementById("content_gomap").className='disappear';
	}else if(document.getElementById("content_graph").className=='appear'){
		document.getElementById("content_graph").className='disappear';
	}else if(document.getElementById("content_about").className=='appear'){
		document.getElementById("content_about").className='disappear';
	}
}
